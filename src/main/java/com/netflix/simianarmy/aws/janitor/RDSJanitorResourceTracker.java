...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
    ...
    public void addOrUpdate(Resource resource) {
    	...
    	if (orig == null) {
    		addResourceTracker(resource, json);
    	} else {
    		updateResourceTracker(resource, json);
    	}
    	LOGGER.debug("Successfully saved.");
    }

	private void updateResourceTracker(Resource resource, String json) {
	...
	private void addResourceTracker(Resource resource, String json) {
		StringBuilder sb = new StringBuilder();
